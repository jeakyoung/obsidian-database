...
- [[01_Projects/07_UNI/2024_PaekTaekApp/01_Tasks|작업 목록]] - 회원가입 다단계 분리·SALT 도입, 이미지 업로드 구조, 이메일 인증, DB FK 제약조건, Git 병합 오류
- [[01_Projects/07_UNI/2024_PaekTaekApp/02_Docs|프로젝트 문서]] - 프로젝트 개요, 개발 과정
- [[01_Projects/07_UNI/2024_PaekTaekApp/03_TechDocs|기술 문서]] - 3계층 구조, SALT 인증 흐름, 이미지 저장 구조, 게시판 CRUD 패턴

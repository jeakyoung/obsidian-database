...
- [[01_Projects/02_iFrog/02_TechDocs/[기술] 보안코드 기반 멀티테넌시 커넥션 구조]] — 같은 계열 코드베이스의 후속 진화 버전(참고용, 구현은 다름)

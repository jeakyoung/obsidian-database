...
| 항목 | 내용 |
|:--|:--|
| **요청자** | 신진SM 현장 (09-08 내부 미팅 반영) |
| **요청일** | 2026-09-08 |
| **대상 시스템** | MES |
| **관련 화면·프로그램** | WPR559(생산실적등록), WMA624(재고조정 엑셀 업로드) |
...
WPR559 화면 개선 및 WMA624 배치 처리 변경 모두 적용 완료. 성능 개선 수치(위 표)는 붙여넣기/엑셀 업로드 처리 방식 변경 전후 비교 기준.

## 🔗 참고

- [[신진SM MES 품목 정보 조치 방안]] — 같은 WMA624 화면의 선행 수정(사업장 코드 불일치)
- [[신진SM 도면가공 체계 MES 동기화 작업]] — WPR559 화면의 후속 대형 작업(도면가공 연동)
- [[신진SM 개발 이력]]

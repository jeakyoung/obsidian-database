...
| **요청자** | — |
| **요청일** | 2026-06-10 |
| **대상 시스템** | 생산관리 / 재고관리 / 구매자재 |
| **관련 화면·프로그램** | 제판완료등록, 공정별재공현황, 기타입고등록(SP_WMA322_01_IUD) |
...
> [!note]
> `SP_WMA322_01_IUD`는 실제 SP다 — `src/com/MA/WMA320/jvWMA322_01_IUD.java`가 이 이름을 호출한다(기타입고등록 관련 모듈).

## 🔗 참고

- iPlusERP: `src/com/MA/WMA320/jvWMA322_01_IUD.java`

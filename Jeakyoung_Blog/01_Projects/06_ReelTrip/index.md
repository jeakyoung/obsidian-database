...
- [[01_Projects/06_ReelTrip/01_Tasks|작업 목록]] - 서비스 구동, DB 아키텍처, 더미데이터 실DB 전환, Todo·채팅 기능 구현
- [[01_Projects/06_ReelTrip/02_Docs|프로젝트 문서]] - 프로젝트 개요, 개발 과정
- [[01_Projects/06_ReelTrip/03_TechDocs|기술 문서]] - GitHub 협업, DB 최적화, 환경 구성 가이드, API 인증 흐름, 모노레포 기반 설정

...
F1soft에서 ERP·MES 시스템과 모바일 백엔드 API 개발에 참여했고, 개인 학습 프로젝트를 병행하고 있습니다. 기능 구현뿐 아니라 데이터 정합성과 시스템 설계, 문제 원인 규명에 중점을 두고 일해 왔습니다.
...
| **기간** | 2026년 진행중 |
| **기술 스택** | Turborepo 모노레포 · Spring Boot 3 + Next.js 15 + React Native(Expo) · MyBatis, PostgreSQL(Supabase), Flyway, pgvector |

...
nohup dotnet F1Soft.Starmap.Service.dll --urls "[http://127.0.0.1:30220](http://127.0.0.1:30220)" --serviceName data_boucher_prd> data_boucher_prd.log >&1 &

tkd

nohup dotnet F1Soft.Starmap.Service.dll --urls "[http://127.0.0.1:30110](http://127.0.0.1:30110)" --serviceName data_boucher_dev> data_boucher_dev.log>&1 &
